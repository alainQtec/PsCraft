function Get-HelpText {
  ...
  #   The function then loops through each element in the XML file, extracting the command name, synopsis, and description from the XML, and adding them to the help text string.
  #   It also loops through each element in the element, adding the parameter name and description to the help text.
  # .LINK
  #   https://github.com/alainQtec/PsCraft/blob/main/Public/Get-HelpText.ps1
  # .EXAMPLE
